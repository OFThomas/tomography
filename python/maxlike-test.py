...
#############################################################
# Title: Testing maximum likelihood estimation
#
# Date created: 11th June 2018
#
# Language:    Python 3
#
# Overview:    The program tests the maximum likelihood
#              estimation of a density matrix from
#              simulated X, Y and Z measurements
#
...
x_start = 0.2 # Specify purity parameter x range
x_end = 0.8
N = 20  # Number of random density matrices per x value
S = 3  # Number of samples of each measurement to
...
for k in range(M):
    ...
    for n in range(N):
        ...
        #
        dens_est = estimation.ML.XYZ(X_data, Y_data, Z_data, proj)
